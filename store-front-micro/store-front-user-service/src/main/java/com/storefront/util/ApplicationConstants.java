...
public final class ApplicationConstants {
	...
	public static final String PROPERTY_KEY_ACP_CHECK_TOKEN = "${acp.token.check}";
	public static final String PROPERTY_KEY_ACP_LEARNING_PROGRAM_ALL = "${acp.learning.program.all}";
	public static final String PROPERTY_KEY_ACP_FLUIDIC_PLAYER_URL = "${acp.fluidic.player.url}";
	public static final String PROPERTY_KEY_ACP_POST_USER_URL = "${acp.post.new.user}";
	
	public static final String PROPERTY_KEY_ACP_SUCCESS_USER_REGISTRATION = "${acp.success.user.registration}";
